...
import { CheckCircle, HelpCircle, Info, Shield, Sparkles, AlertTriangle, Crosshair, FileText, Pill, ShoppingCart, ThumbsDown, Stethoscope, HeartHandshake, BookHeart, Leaf } from "lucide-react";
...
const ResultsDisplay = ({ isLoading = false, hasResults = false, image, results }: ResultsDisplayProps) => {
                ...
                {overviewSections.map((section) => (
                  <div key={section.key} className="mb-6">
                    ...
                    <p className="text-gray-300">
                      {results?.[section.key] || "No content available for this section."} {/* Dynamically fetch data */}
                    </p>
                  </div>
                ))}
              </motion.div>
